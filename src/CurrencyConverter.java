...
public class CurrencyConverter extends JFrame{
    ...
    private final HashMap<String, String> CURRENCY_SYMBOLS = new HashMap<>() {{
        ...
        put("Costa Rica Colon", "CRC");
        put("Nicaragua Cordoba", "NIO");
        put("Guatemala Quetzal", "GTQ");
        put("Belize Dollar", "BZD");
        put("Honduras Lempira", "HNL");
        put("Dominican Peso", "DOP");
        put("Haiti Gourde", "HTG");
        put("Jamaica Dollar", "JMD");
        put("Cuba Peso", "CUP");
        put("Bahamas Dollar", "BSD");
        put("Cayman I. Dollar", "KYD");
        put("Guyana Dollar", "GYD");
        put("Suriname Dollar", "SRD");
        put("Venezuela Bolivar", "VES");
        put("Mexico Peso", "MXN");
        put("Canada Dollar", "CAD");
        put("US Dollar", "USD");
        put("Euro", "EUR");
        put("UK Pound Sterling", "GBP");
        put("Japan Yen", "JPY");
        put("Korea Won", "KRW");
    }};
